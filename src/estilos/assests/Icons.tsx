...
function Icons(){
    ...
    function Fixar({tamanho, cor, style}:Icons){
        return(
            <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 512 512"
    ...
    function Fugir({tamanho, cor, style}:Icons){
        return(
            <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 512 512"
    ...
    function Mapa({tamanho, cor, style}:Icons){
        return(
            <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 512 512"
    ...
    function PersongemInfo({tamanho, cor, style}:Icons){
        return(
            <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 512 512"
    ...
    function Seguir({tamanho, cor, style}:Icons){
        return(
            <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 512 512"
    ...
    function Vida({tamanho, cor, style}:Icons){
        return(
            <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 512 512"
    ...
    function Voltar({tamanho, cor, style}:Icons){
        return(
        <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 512 512"
