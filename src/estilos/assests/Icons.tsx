...
function Icons(){
    ...
    function Anotacao({tamanho, cor, style, onClick, classe, }:IconsProp){
        return(
            <div onClick={onClick} className={classe} >
                <svg
                ...
                <g transform="translate(0,0)" style={style}>
                    ...
                    fill={cor} fillOpacity="1"></path>
                </g>
                </svg>
            </div>
        )
    }
    function Fixar({tamanho, cor, style, onClick, classe}:IconsProp){
        return(
            <div onClick={onClick} className={classe}>
                <svg
                xmlns="http://www.w3.org/2000/svg"
                ...
                style={style}
                        >
                    <g transform="translate(0,0)" style={style}><path d="M326.953 22.87L306.68 83.685l20.273 20.273-115.428 115.427c-16.39-8-34.277-14.452-51.84-18.502-14.247-3.285-28.136-4.902-40.802-4.772-16.84.173-31.505 3.44-41.975 9.973l229.006 229.006c11.447-18.345 12.853-49.592 5.2-82.776-4.05-17.564-10.502-35.45-18.5-51.84l115.427-115.43 20.274 20.274 60.817-20.273L326.954 22.87zM159.207 313.84L22.87 489.13l175.29-136.337-38.953-38.953z" fill={cor} fillOpacity="1" transform="translate(25.6, 25.6) scale(0.9, 0.9) rotate(0, 256, 256) skewX(0) skewY(0)"></path></g></svg>
            </div>
        )
    }
    function Fugir({tamanho, cor, style, onClick, classe}:IconsProp){
        return(
            <div onClick={onClick} className={classe}>
                <svg
                xmlns="http://www.w3.org/2000/svg"
    ...
    function Mapa({tamanho, cor, style, onClick, classe}:IconsProp){
        return(
            <div onClick={onClick} className={classe}>
                ...
                style={style}
                        >
                    <g transform="translate(0,0)" style={style}><path d="M256 17.108c-75.73 0-137.122 61.392-137.122 137.122.055 23.25 6.022 46.107 11.58 56.262L256 494.892l119.982-274.244h-.063c11.27-20.324 17.188-43.18 17.202-66.418C393.122 78.5 331.73 17.108 256 17.108zm0 68.56a68.56 68.56 0 0 1 68.56 68.562A68.56 68.56 0 0 1 256 222.79a68.56 68.56 0 0 1-68.56-68.56A68.56 68.56 0 0 1 256 85.67z" fill={cor} fillOpacity="1"></path></g></svg>
            </div>
        )
    }
    function PersongemInfo({tamanho, cor, style, onClick, classe}:IconsProp){
        return(
            <div onClick={onClick} className={classe}>
                <svg
                xmlns="http://www.w3.org/2000/svg"
    ...
    function Seguir({tamanho, cor, style, onClick, classe}:IconsProp){
        return(
            <div onClick={onClick} className={classe}>
                ...
                style={style}
                        >
                    <g transform="translate(0,0)" style={style}><path d="M130.81 21.785v245.95H43.84L256 489.382l212.158-221.644H381.19V21.786H130.81z" fill={cor} fillOpacity="1" transform="translate(512, 0) scale(-1, 1) rotate(90, 256, 256) skewX(0) skewY(0)"></path></g></svg>
            </div>
            )
    }
    function Vida({tamanho, cor, style, onClick, classe}:IconsProp){
        return(
            <div onClick={onClick} className={classe}>
                <svg
                xmlns="http://www.w3.org/2000/svg"
                ...
                style={style}
                        >
                   <g transform="translate(0,0)" style={style}>
                    <path d="M480.25 156.355c0 161.24-224.25 324.43-224.25 324.43S31.75 317.595 31.75 156.355c0-91.41 70.63-125.13 107.77-125.13 77.65 0 116.48 65.72 116.48 65.72s38.83-65.73 116.48-65.73c37.14.01 107.77 33.72 107.77 125.14z" fill={cor} fillOpacity="1" transform="translate(486.4, 25.6) scale(-0.9, 0.9) rotate(0, 256, 256) skewX(0) skewY(0)"></path></g>
                </svg>
            </div>
        )
    }
    function Voltar({tamanho, cor, style, onClick, classe}:IconsProp){
        return(
        <div onClick={onClick} className={classe}>
            <svg
                xmlns="http://www.w3.org/2000/svg"
